...
<body>
    ...
    <section class="container-fluid">
        <div class="px-4 py-5 px-md-5 text-center text-lg-start d-flex align-items-center"
                                ...
                                <form action="{{ route('store.register.post') }}" method="post"
                                    ...
                                    <div data-mdb-input-init class="form-outline mb-4">
                                        @error('password_confirmation')
                                            <p class="small text-danger">{{ $message }}</p>
                                        @enderror
                                        <label class="form-label d-flex" for="password_confirmation">Retype
                                            Password</label>
                                    ...
                                    <div class="text-center">
                                        <a href="{{ route('store.login') }}" class="text-decoration-none small">Already
                                            have account?</a>
                                    </div>
                                </form>
                            </div>
